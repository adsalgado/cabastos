...
export class ClienteService {
  ...
  protected convertDateFromClient(cliente: ICliente): ICliente {
    const copy: ICliente = Object.assign({}, cliente, {
      fechaAlta: cliente.fechaAlta && cliente.fechaAlta.isValid() ? cliente.fechaAlta.toJSON() : undefined,
      fechaModificacion: cliente.fechaModificacion && cliente.fechaModificacion.isValid() ? cliente.fechaModificacion.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((cliente: ICliente) => {
        ...
        cliente.fechaModificacion = cliente.fechaModificacion ? moment(cliente.fechaModificacion) : undefined;
      });
    }
    return res;
  }
